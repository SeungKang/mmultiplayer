...
namespace ImGui
{
    ...
    IMGUI_API bool          SliderScalar(const char* label, ImGuiDataType data_type, void* v, const void* v_min, const void* v_max, void *highlights, int num_highlights, const char* format = nullptr, float power = 1.0f);
